...
public class FenetreResultats extends JFrame
{
	...
	public FenetreResultats(Grille g) {
		...
		this.setTitle("RŽsultats - EnsiStats");
	...
	private void initComposant(Grille g) {
		...
		if (r[0] != null) {
			...
			weiter = false;
			JOptionPane.showMessageDialog(null, "Oups, a n'a pas marchŽ !\n ætes vous sžr d'avoir bien rempli la grille ?", "Erreur ! - EnsiStats", JOptionPane.ERROR_MESSAGE);
		}
	}
